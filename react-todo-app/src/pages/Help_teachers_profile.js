...
export default function Help() {
  ...
  return (
    <div>
        <div>{nav}</div>
        <div className="breadcrumb_body5">{Arxiki()} <Link to="/help">Βοήθεια / </Link><Link to="/help_teachers">Διδάσκοντες / </Link><span>Επεξεργασία Προφίλ</span></div>
        ...
        <div className="body_hdilosis">
            ...
            <li>Πλοηγηθείτε στον πίνακα με τις προσωπικές σας πληροφορίες μέσω των δύο επιλογών που σας δίνονται, <span class="bold">Προσωπικά στοιχεία</span>,  <span class="bold">Πληροφορίες Επικοινωνίας</span> και τροποποιήστε τα στοιχεία που επιθυμείτε συμπληρώνοντας τα πλαίσια.</li>
