    ...
    <div>
        ...
        <div className="body_hdilosis">
            ...
            <li>Επιλέξτε τα μαθήματα που ενδιαφέρεστε να παρακολουθήσετε στο τρέχον εξάμηνο, λαμβάνοντας υπόψη το όριο δήλωσης μαθημάτων του εξαμήνου σας και πατήστε <span class="bold">Προσωρινή αποθήκευση</span>.
              Όσο μία δήλωση βρίσκεται σε κατάσταση προσωρινής αποθήκευσης μπορείτε να την δείτε και να την επεξεργαστείτε από το <span class="bold">Iστορικό</span>. Οι δηλώσεις που βρίσκονται σε κατάσταση προσωρινής αποθήκευσης θα πρέπει να οριστικοποιηθούν μέχρι το τέλος της περιόδου δηλώσεων αλλιώς θα λήξουν.
