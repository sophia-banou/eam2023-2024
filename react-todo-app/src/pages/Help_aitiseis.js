  ...
  return (
    <div>
        ...
        <div className="body_hdilosis">
            ...
            <li>Στο προφίλ σας πατήστε την επιλογή Ιστορικό.</li>
            <li>Πλοηγηθείτε στους πίνακες των Δηλώσεων και των Πιστοποιητικών χρησιμοποιώντας την μπάρα πλοήγησης.</li>
